    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Registrar nuevo huesped</h5>
            </div>
            <div class="card-body">
                <form action="{{ route('backend.guests.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('incident_notes') is-invalid @enderror" id="incident_notes" name="incident_notes" rows="2">{{ old('incident_notes') }}</textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" id="is_frequent" name="is_frequent" value="1" {{ old('is_frequent') ? 'checked' : '' }}>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Crear huesped
                            </button>
